...
const StartScreen = ({ totalQuestions, onStart }: StartScreenProps) => {
  const [selectedMode, setSelectedMode] = useState<'audio' | 'video' | 'none'>('none');

  return (
    <Card className="w-full max-w-2xl">
      <CardHeader className="text-center">
        <CardTitle className="text-3xl">F1 Visa Interview Prep</CardTitle>
        <CardDescription>Practice answering common interview questions</CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
          <div className="flex items-center gap-3 p-3 bg-secondary/50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">{totalQuestions} practice questions</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-secondary/50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">PhD & Research topics</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-secondary/50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Simulate real interview</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3 p-3 bg-secondary/50 rounded-lg">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Targeted university prep</p>
            </div>
          </div>
        </div>
        
        <div className="bg-primary/10 p-4 rounded-lg mt-4">
          <h3 className="font-medium text-primary mb-2">Choose your practice mode:</h3>
          ...
          <p className="mt-4 text-sm text-muted-foreground">
            {selectedMode === 'audio' && "Record audio responses to practice your verbal communication skills."}
            {selectedMode === 'video' && "Record video responses to practice both verbal and non-verbal communication."}
        ...
        <div className="bg-primary/10 p-4 rounded-lg mt-4">
          ...
          <ul className="mt-2 space-y-1 text-sm">
            <li>• Answer each question as if you were in the actual interview</li>
            <li>• Time yourself to keep responses concise and focused</li>
            <li>• Practice regularly to build confidence and fluency</li>
            <li>• Use the "Skip" button if you need to come back to a question</li>
          </ul>
        </div>
      </CardContent>
      <CardFooter>
